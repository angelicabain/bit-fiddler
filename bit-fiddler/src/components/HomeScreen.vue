...
export default {
  ...
  data() {
    return {
      // strings: ["Bit shit", "Bit shitl", "Bit shittl", "Bit shittle", "Bit shittler", "Bit shitdler", "Bit shiddler", "Bit siddler", "Bit Fiddler"],
      strings: [],
      currentText: "",
      currentIndex: 0,
      delay: 75,
  ...
  methods: {
    ...
    animateText() {
      if(this.currentIndex < this.strings.length) {
        ...
        // if(this.delay < 300){
        //   this.delay = Math.pow(this.delay, 1.0025);
        // }
...
.view-frame-bottom {
  ...
  animation-delay: 5s; /* Delay for main container to fade in first */
}

/* Sequential fade-in for individual elements */
